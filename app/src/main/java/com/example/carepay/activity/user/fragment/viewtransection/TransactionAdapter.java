...
public class TransactionAdapter extends BaseAdapter {
    ...
    public TransactionAdapter(Activity context , ArrayList<HashMap<String,String>>   list){
    ...
    public View getView(final int position, View r, ViewGroup parent){
        ...
        String name = map.get("receiver_name");
        String image_url = map.get("receiver_image_url");
        if (name!=null)
            txt_name.setText("Youy have deposited "+amount+"Rs. in "+name+"'s account on "+date);
        if (image_url!=null)
